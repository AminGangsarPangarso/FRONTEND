  ...
  return (
    ...
    >
      ...
      <div className='mb-4'>
        <label htmlFor='image' className='mb-1 block px-2 font-medium '>
          ...
          <input
            ...
            className='mt-2 w-full rounded border border-gray-300 px-3 py-2 focus:border-blue-500 focus:outline-none focus:ring-blue-500'
          />
        </label>
      </div>
      ...
      <div className='m-2 flex justify-between'>
        ...
        <button
          type='submit'
          className='w- rounded bg-blue-500 px-4 py-2 text-white hover:bg-blue-600 focus:bg-blue-600 focus:outline-none'
        >
          Simpan
        </button>
      </div>
